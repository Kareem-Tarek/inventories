...
@section('title-heading_2', 'جميع المنتجات')
        ...
        <div class="row my-4">
          ...
          <div class="col-md-12">
            <div class="card shadow">
              <div class="card-body">
                <!-- table -->
                        <table class="table table-bordered border border-5 table-hover mb-0 @if($products->count() == 0) d-none @endif">
                        ...
                        <div class="alert alert-danger text-center">
                            <span class="h6">لا توجد منتجات في قاعدة البيانات حتى الآن!</span>
                        </div>
                    @endforelse
                            </tbody>
                        </table>
